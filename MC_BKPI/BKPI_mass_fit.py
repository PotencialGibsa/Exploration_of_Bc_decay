...
for evt in range(nEvt):
	...
	if Bc_mass < 6.2: continue
	if Bc_mass > 6.35: continue
...
if FITTING :
	...
	S1_sigma = RooRealVar ("S1_sigma", "sigma"   , 0.01, 0.00001, 10   )
	S2_sigma = RooRealVar ("S2_sigma", "gamma"   , 0.01, 0, 10    )
	...
	k    = RooRealVar ( "k"   , "k", 0.0, -100.0, 100.0   )
