...
MyFileNames = glob.glob('/eos/home-d/dshmygol/Bc_Bfinder/201?_MC_Bc_in_BKPI_v6_trigger_mathcing/*/*/*/000?/BFinder*.root')
...
for name in MyFileNames:
    ...
    chain.Add(name)
    Name_count+=1
_fileOUT = '/eos/home-d/dshmygol/SimpleFile_MC_Bc_in_BKPI_v7_trigger_matching.root'
...
for evt in range(nevt):
	...
	for cand in range(_nCand):
		...
		gen_kaon2_delta[0] = chain.gen_kaon1_p4.DeltaR(K2P4)
		gen_pion1_delta[0] = chain.gen_pion1_p4.DeltaR(PI3P4)
