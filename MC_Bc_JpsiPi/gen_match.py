...
x = RooRealVar('delta','delta',0, 0.01)
varset = RooArgSet(x)
dh = 0
...
for evt in range(nEvt):
	...
	#if Bc_mass < 6.18: continue
	#if delta_PI1 > 12: continue
...
canvas.SaveAs('Deltamu2' + '.png')

#canvas.SaveAs('genM_fit_decatype_' + str(DECATYPE) + '.png')
