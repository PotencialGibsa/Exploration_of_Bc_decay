...
for year in years:
    for part in [1,2]:
        MyFileNames = glob.glob('/eos/home-d/dshmygol/Bc_Bfinder/201' + str(year) + '_Bc_in_BKPI_v6_trigger_matching/*/Charmonium/*/*/000?/BFinder*.root')
        if part == 1:
        ...
        _fileOUT = '/eos/home-d/dshmygol/SimpleFile_Bc_in_BKPI/SimpleFile_Bc_in_BKPI_v6_trigger_matching_201'+str(year)+'_part_'+str(part)+'.root'
